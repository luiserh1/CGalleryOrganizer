...
typedef struct {
  ...
  GuiRect history_rollback_mode_label;
  GuiRect history_rollback_any;
  GuiRect history_rollback_yes;
  GuiRect history_rollback_no;
  GuiRect history_from_label;
  GuiRect history_from_input;
  GuiRect history_to_label;
  GuiRect history_to_input;
  GuiRect preview_button;
  GuiRect apply_button;
  GuiRect history_button;
  GuiRect detail_button;
  GuiRect redo_button;
  GuiRect preflight_button;
  GuiRect rollback_button;
  ...
  GuiRect history_export_label;
  GuiRect history_export_input;
  GuiRect history_export_button;
  GuiRect history_prune_label;
  GuiRect history_prune_input;
  GuiRect history_prune_button;
