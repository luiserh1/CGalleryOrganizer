...
void test_gui_fixed_rename_layout_no_overlap(void) {
  ...
  GuiRect rects[] = {
      ...
      rename.history_rollback_mode_label, rename.history_rollback_any,
      rename.history_rollback_yes, rename.history_rollback_no,
      rename.history_from_label, rename.history_from_input,
      rename.history_to_label, rename.history_to_input,
      ...
      rename.preflight_button, rename.rollback_button,
      ...
      rename.history_export_label, rename.history_export_input,
      rename.history_export_button, rename.history_prune_label,
      rename.history_prune_input, rename.history_prune_button,
      rename.info_label,
